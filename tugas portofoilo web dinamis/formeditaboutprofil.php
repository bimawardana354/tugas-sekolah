...
<html lang="en">
  ...
  <body>   
            ...
            <div class="container">
              ...
              <div class="row">
                <div class="list shadow-sm fs-4 fw-bold rounded-3 text-center mx-auto mt-4 pt-2" style="width: 1000px; margin-bottom: 10px; height: 50px; color: #fff; background-color: #4b7bec"><i class="bi bi-pencil-square"></i> Edit Data Diri</div>
              </div>
                ...
                <form action="editaboutprofil.php" method="POST">
                  ...
                  <input type="hidden" class="mb-2  mt-2" name="id_about_p" value="<?php echo $pro['id_about_p']?>">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                              <input type="radio" class="mb-4 mt-3" name="jk" id="cowo" value="Laki-laki"> Laki-laki
                              <input type="radio" class="mb-4 mt-3" name="jk" id="cewe" value="Perempuan"> Perempuan
                          </div>
                      </div>
                      ...
                      <div class="form-group row">
                          <label for="tempattanggallahir" class="col-sm-3 col-form-label">Tempat, Tanggal Lahir</label>
                          <div class="col-sm-8">
                              <input type="text" class="form-control mb-4" name="ttl" value="<?php echo $pro['ttl']?>">
                          </div>
                      </div>
                      ...
                      <div class="form-group float-end me-5 mt-4">
                          ...
                          <button type="submit" style="width: 100px;" class="btn btn-lg btn-outline-dark mt-2 ms-4 me-5" name="simpaneditaboutprofil">Edit</button> 
                      </div>
             </form>
