      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item ms-2">
              <button type="button" class="btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal">Info Admin</button>
            </li> 
          </ul>
        </div>

        <a class="ms-3 text-white" style="text-decoration: none;" href="logout.php"><i class="bi bi-box-arrow-in-left"></i>Logout</a>
      </div>
    </nav>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center fs-5">
          ...
          <div class="col-md-4">
            ...
            <p>
              Tempat Lahir :
              <?php echo $tmpil['tempat_lahir'] ?>
            </p>
            <p>
              Tanggal Lahir :
              <?php echo $tmpil['tanggal_lahir'] ?>
            </p>
            <p>
              Alamat :
    ...
    <section id="gallery" class="gallery">
      <div class="container">
       ...
       <div class="row justify-content-center">
        ...
        <button type="button" class="btn-success btn-lg shadow-sm mt-3 me-5" style="float: right;"><a class="inia2" href="tambahgallery.php"><i class="bi bi-plus-square"></i> Tambah Gallery</a></button>
