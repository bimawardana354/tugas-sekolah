        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item ms-2">
              <button type="button" class="btn-secondary" onclick='top.location="login.php"'>Admin</button>
            </li>
          </ul>
        </div>

        <a class="ms-3 text-white" style="text-decoration: none;" href="cetakpdf.php" target="_blank"><i class="bi bi-box-arrow-in-left"></i>Cetak PDF</a>
      </div>
    </nav>
